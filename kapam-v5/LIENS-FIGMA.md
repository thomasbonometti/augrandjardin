# Kapam — Index v5 : liens Figma des éléments créés ou modifiés

Fichier : `oGJVoOgpCvgf0DnCJTBLdU` · page **🖥️ Pages (Desktop)**

Chaque lien ouvre le node directement. Les 74 nodes ont été vérifiés comme existants avant génération de cette liste.
...
## A1 — CTA final : boutons collés

Section : [S12 — CTA final + newsletter](https://www.figma.com/design/oGJVoOgpCvgf0DnCJTBLdU/Kapam?node-id=8636-47120)

- [Scrim haut](https://www.figma.com/design/oGJVoOgpCvgf0DnCJTBLdU/Kapam?node-id=8643-15) — **créé** — style `overlay/scrim-top`
- [Temps 1 — CTA de conversion](https://www.figma.com/design/oGJVoOgpCvgf0DnCJTBLdU/Kapam?node-id=8636-47124) — remonté de y=128 à y=24, contrainte CENTER
- [Boutons](https://www.figma.com/design/oGJVoOgpCvgf0DnCJTBLdU/Kapam?node-id=8636-47126) — gap lié au token `component/gap/md`

## A2 — En savoir plus : liens désalignés

Section : [S11](https://www.figma.com/design/oGJVoOgpCvgf0DnCJTBLdU/Kapam?node-id=8636-47096)

- [Bloc — Compatibilité](https://www.figma.com/design/oGJVoOgpCvgf0DnCJTBLdU/Kapam?node-id=8636-47099) — restructuré (puis aplati en A10)

## A3 — Hero : titre sur la couture

Section : [S2 — Hero](https://www.figma.com/design/oGJVoOgpCvgf0DnCJTBLdU/Kapam?node-id=8636-46932)

- [Hero — texte posé sur l'image](https://www.figma.com/design/oGJVoOgpCvgf0DnCJTBLdU/Kapam?node-id=8636-46945) — contraint à 360 px = panneau 1
- [Titre « Votre chambre vous suit… »](https://www.figma.com/design/oGJVoOgpCvgf0DnCJTBLdU/Kapam?node-id=8636-46947) — 56 px → 30 px, 2 lignes
- [Ancres internes](https://www.figma.com/design/oGJVoOgpCvgf0DnCJTBLdU/Kapam?node-id=8636-46948) — wrap activé
- [Button — EXPLORER LES KITS](https://www.figma.com/design/oGJVoOgpCvgf0DnCJTBLdU/Kapam?node-id=8636-46949) — Size md → sm
- [Button — VOUS EN ÊTES OÙ ?](https://www.figma.com/design/oGJVoOgpCvgf0DnCJTBLdU/Kapam?node-id=8636-46950) — Size sm + **ancre SCROLL_TO créée**
- [Scrim bas](https://www.figma.com/design/oGJVoOgpCvgf0DnCJTBLdU/Kapam?node-id=8636-46944) — style `overlay/scrim-bottom-strong`

## A4 — S9 : la section n'a pas de titre

Section : [S9 — Les trois formules](https://www.figma.com/design/oGJVoOgpCvgf0DnCJTBLdU/Kapam?node-id=8636-47031)

- [Titre de section](https://www.figma.com/design/oGJVoOgpCvgf0DnCJTBLdU/Kapam?node-id=8660-22) — **créé** — bloc complet
- [LES TROIS FORMULES](https://www.figma.com/design/oGJVoOgpCvgf0DnCJTBLdU/Kapam?node-id=8660-23) — **créé** — sur-titre
- [Vous en êtes où ?](https://www.figma.com/design/oGJVoOgpCvgf0DnCJTBLdU/Kapam?node-id=8660-24) — **créé** — titre, x=120
- [Prix — 2 000 €](https://www.figma.com/design/oGJVoOgpCvgf0DnCJTBLdU/Kapam?node-id=8662-14) — **créé** — `display/3xl/bold`
- [Prix — 5 000 €](https://www.figma.com/design/oGJVoOgpCvgf0DnCJTBLdU/Kapam?node-id=8662-15) — **créé**
- [Prix — 25 000 €](https://www.figma.com/design/oGJVoOgpCvgf0DnCJTBLdU/Kapam?node-id=8662-16) — **créé**
- [Label + sous-ligne (tuile 1)](https://www.figma.com/design/oGJVoOgpCvgf0DnCJTBLdU/Kapam?node-id=8636-47037) — aligné à gauche, x=48
- [Label + sous-ligne (tuile 2)](https://www.figma.com/design/oGJVoOgpCvgf0DnCJTBLdU/Kapam?node-id=8636-47044) — aligné à gauche
- [Label + sous-ligne (tuile 3)](https://www.figma.com/design/oGJVoOgpCvgf0DnCJTBLdU/Kapam?node-id=8636-47051) — aligné à gauche

## A5 — S8 : scinder les deux sujets

Section : [S8 — Atelier](https://www.figma.com/design/oGJVoOgpCvgf0DnCJTBLdU/Kapam?node-id=8636-47016)

- [S8b — Personnalisation (pleine largeur)](https://www.figma.com/design/oGJVoOgpCvgf0DnCJTBLdU/Kapam?node-id=8667-149) — **section créée**
- [Nuancier de coloris](https://www.figma.com/design/oGJVoOgpCvgf0DnCJTBLdU/Kapam?node-id=8667-150) — **créé**
- [Échantillons](https://www.figma.com/design/oGJVoOgpCvgf0DnCJTBLdU/Kapam?node-id=8667-151) — **créé** — 12 pastilles
- [Coloris — stone/50](https://www.figma.com/design/oGJVoOgpCvgf0DnCJTBLdU/Kapam?node-id=8667-152) — **créé** — première pastille
- [Coloris — ink](https://www.figma.com/design/oGJVoOgpCvgf0DnCJTBLdU/Kapam?node-id=8667-163) — **créé** — dernière pastille
- [[À VALIDER WILLY] — légende nuancier](https://www.figma.com/design/oGJVoOgpCvgf0DnCJTBLdU/Kapam?node-id=8667-164) — **créé**
- [Atelier — panneau texte](https://www.figma.com/design/oGJVoOgpCvgf0DnCJTBLdU/Kapam?node-id=8636-47026) — repris du panneau Personnalisation
- [Atelier — bloc texte](https://www.figma.com/design/oGJVoOgpCvgf0DnCJTBLdU/Kapam?node-id=8636-47022) — sorti de l'image
- [[À VALIDER WILLY] — phrase atelier](https://www.figma.com/design/oGJVoOgpCvgf0DnCJTBLdU/Kapam?node-id=8668-14) — **créé**
- [Scrim haut (atelier)](https://www.figma.com/design/oGJVoOgpCvgf0DnCJTBLdU/Kapam?node-id=8668-16) — **créé** — corrige l'eyebrow illisible
- [Tag / Badge — BOIS PEFC · LABEL A+](https://www.figma.com/design/oGJVoOgpCvgf0DnCJTBLdU/Kapam?node-id=8636-47025) — ancré MAX, 24 px du bord

## A6 — S5 / S7 : nettoyer les carrousels
...
## A7 — S4 : rendre les familles distinctes
...
## A8 — S3 : resserrer le statement

Section : [S3 — Statement](https://www.figma.com/design/oGJVoOgpCvgf0DnCJTBLdU/Kapam?node-id=8636-46951)

- [Statement](https://www.figma.com/design/oGJVoOgpCvgf0DnCJTBLdU/Kapam?node-id=8636-46952) — 1120 → 560 px (`width/text-md`)
- [Lien — DÉCOUVRIR L'ATELIER](https://www.figma.com/design/oGJVoOgpCvgf0DnCJTBLdU/Kapam?node-id=8636-46953) — souligné
- [[v5 retiré] ATELIER ARTISAN DEPUIS 2011 · GIRONDE](https://www.figma.com/design/oGJVoOgpCvgf0DnCJTBLdU/Kapam?node-id=8636-46946) — **archivé** — eyebrow du hero

## A9 — S10 : 4 colonnes → 3

Section : [S10 — Le Journal](https://www.figma.com/design/oGJVoOgpCvgf0DnCJTBLdU/Kapam?node-id=8636-47055)

- [Trois articles](https://www.figma.com/design/oGJVoOgpCvgf0DnCJTBLdU/Kapam?node-id=8636-47059) — cards à 384 px
- [IMG JOURNAL-01](https://www.figma.com/design/oGJVoOgpCvgf0DnCJTBLdU/Kapam?node-id=8636-47061) — 384 × 288, ratio 4:3 rétabli
- [[v5 retiré] Article — JOURNAL-04](https://www.figma.com/design/oGJVoOgpCvgf0DnCJTBLdU/Kapam?node-id=8636-47087) — **archivé**

## A10 — S11 : dégénériser

Section : [S11](https://www.figma.com/design/oGJVoOgpCvgf0DnCJTBLdU/Kapam?node-id=8636-47096)

- [Avant de commander](https://www.figma.com/design/oGJVoOgpCvgf0DnCJTBLdU/Kapam?node-id=8636-47097) — titre renommé
- [Image + liste](https://www.figma.com/design/oGJVoOgpCvgf0DnCJTBLdU/Kapam?node-id=8636-47098) — grille → image large + liste
- [Liste — avant de commander](https://www.figma.com/design/oGJVoOgpCvgf0DnCJTBLdU/Kapam?node-id=8699-14) — **créé**
- [IMG SAVOIR-VASP](https://www.figma.com/design/oGJVoOgpCvgf0DnCJTBLdU/Kapam?node-id=8636-47107) — promu en image large 588 × 470
- [[v5 retiré] IMG SAVOIR-COMPATIBILITE](https://www.figma.com/design/oGJVoOgpCvgf0DnCJTBLdU/Kapam?node-id=8636-47100) — **archivé**
- [[v5 retiré] IMG SAVOIR-HISTOIRE](https://www.figma.com/design/oGJVoOgpCvgf0DnCJTBLdU/Kapam?node-id=8636-47114) — **archivé**

## A11 — S12 : bloc newsletter

Section : [S12](https://www.figma.com/design/oGJVoOgpCvgf0DnCJTBLdU/Kapam?node-id=8636-47120)

- [Bloc newsletter](https://www.figma.com/design/oGJVoOgpCvgf0DnCJTBLdU/Kapam?node-id=8701-14) — **créé**
- [[À VALIDER WILLY]](https://www.figma.com/design/oGJVoOgpCvgf0DnCJTBLdU/Kapam?node-id=8701-15) — **créé** — eyebrow
- [Titre newsletter](https://www.figma.com/design/oGJVoOgpCvgf0DnCJTBLdU/Kapam?node-id=8701-16) — **créé**
- [Mention RGPD](https://www.figma.com/design/oGJVoOgpCvgf0DnCJTBLdU/Kapam?node-id=8701-17) — **créé**
- [Respiration](https://www.figma.com/design/oGJVoOgpCvgf0DnCJTBLdU/Kapam?node-id=8701-18) — **créé** — rupture photo / bandeau noir
- [Temps 2 — Newsletter](https://www.figma.com/design/oGJVoOgpCvgf0DnCJTBLdU/Kapam?node-id=8636-47130) — 200 → 302 px

## Styles créés

Les styles n'ont pas d'URL de node. Ils sont dans le panneau **Local styles** du fichier :

- `overlay/scrim-top` — miroir de `overlay/scrim-bottom`. Utilisé en A1 et A5.
- `overlay/scrim-bottom-strong` — scrim bas renforcé. Utilisé en A3 uniquement.

`overlay/scrim-bottom` et `overlay/scrim-full` n'ont **pas** été modifiés.
